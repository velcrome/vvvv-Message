...
/// </summary>
    public class VVVVProfile : TypeIdentity
    {
        protected override void Register(TypeIdentity target = null)
        {
            ...
            target.TryAddRecord(new TypeRecord<DX11.DX11Resource<VVVV.DX11.DX11Layer>>("Layer", CloneBehaviour.Null));
            target.TryAddRecord(new TypeRecord<DX11.DX11Resource<FeralTic.DX11.Resources.IDX11ReadableStructureBuffer>>("Buffer", CloneBehaviour.Null));
            target.TryAddRecord(new TypeRecord<DX11.DX11Resource<FeralTic.DX11.Resources.DX11Texture2D>>("Texture2d", CloneBehaviour.Null));
            target.TryAddRecord(new TypeRecord<DX11.DX11Resource<FeralTic.DX11.Resources.IDX11Geometry>>("Geometry", CloneBehaviour.Null));
        }
