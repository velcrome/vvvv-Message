...
namespace VVVV.Packs.Message {
		...
		protected virtual void HandleConfigChange(IDiffSpread<string> configSpread) {
            ...
            foreach (string binConfig in config)
            {
                ...
                try
                {
					...
					if (create)
					{
					    Type type = TypeIdentity.Instance.FindType(alias);
    ...
    #endregion PluginInfo
    public class JoinStorageNode : DynamicNode
    {
#pragma warning disable 649, 169
...
#pragma warning restore
        ...
        public override void Evaluate(int SpreadMax)
        {
            ...
            {
                changed = true;
                messages.Add(new Message(FConfig[0]));
            }
